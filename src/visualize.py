...
def plot(sim):
  ...
  max_stress = max(n.stress for n in nodes)
  ...
  for (node1, node2) in edges:
    x1, y1 = map_pos((node1.userData.px, node1.userData.py))
    x2, y2 = map_pos((node2.userData.px, node2.userData.py))
